...
const CATEGORIES = ['hackathon', 'duel', 'discussion', 'submission', 'canvas', 'achievement', 'system'];
...
export class CreateNotificationDto {
  ...
  @ApiProperty({ description: 'Notification type (e.g. hackathon_starting, duel_result)' })
  @IsString()
  @IsNotEmpty()
  type: string;
  ...
  @ApiProperty({ description: 'Priority level', enum: PRIORITIES, default: 'medium' })
  @IsString()
  @IsIn(PRIORITIES)
  priority: string;
  ...
  @ApiPropertyOptional({ description: 'Type of the related entity (e.g. Hackathon, Duel)' })
  @IsOptional()
  @IsString()
  entityType?: string;
