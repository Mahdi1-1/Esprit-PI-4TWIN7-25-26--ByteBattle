...
export class UsersController {
  ...
  @ApiQuery({ name: "limit", required: false })
  getMyActivity(@CurrentUser("id") userId: string, @Query("limit") limit = 20) {
  ...
  @SkipThrottle()
  @ApiOperation({
    summary: "Get public profile by username (no auth required)",
  })
  ...
  @SkipThrottle()
  @ApiOperation({
    summary: "Get public activity by username (no auth required)",
  })
  ...
  @SkipThrottle()
  @ApiOperation({
    summary: "Search users by username (public, no auth required)",
  })
  @ApiQuery({
    name: "q",
    required: true,
    description: "Username search query (min 2 chars)",
  })
  @ApiQuery({ name: "limit", required: false })
  @ApiResponse({
    status: 200,
    description: "List of matching users (public fields only)",
  })
  ...
  @ApiOperation({
    summary:
      "[Deprecated] Use PATCH /admin/users/:id/role instead — this endpoint lacks audit logging",
    deprecated: true,
  })
  ...
  @Roles("user")
  @ApiOperation({
    summary: "Get AI skill update and challenge recommendations",
  })
