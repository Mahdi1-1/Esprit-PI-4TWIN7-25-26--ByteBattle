...
export class AdminController {
  ...
  @ApiOperation({
    summary:
      "Time-series data for charts (registrations, submissions, duels) over last N days",
  })
  @ApiQuery({
    name: "days",
    required: false,
  ...
  @ApiOperation({
    summary:
      "Platform performance: top challenges, difficulty distribution, hourly activity heatmap",
  })
  ...
  @ApiOperation({
    summary:
      "Module usage: sessions, unique users, engagement rate, avg time per module (last 7d)",
  })
  getModuleUsage() {
